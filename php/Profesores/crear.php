    ...
    <div id="form_container">
        ...
        <form id="form_1078726" class="appnitro" action="insert.php" method="post" enctype="multipart/form-data" onsubmit="return validaFormulario();">
            ...
            <ul>
                ...
                <li id="li_9">
                    <label class="description" for="element_5">Departamento</label><div>
                        <select class="element select medium" required="required" id="element_5"  name="Departamento" onchange="this.style.backgroundColor='white'" x="Classe">
                ...
                <li id="li_8">
                    ...
                    <div class="description" for="element_6">
                        <input  id="element_6" type="file" name="foto_prof" placeholder="Foto" maxlength="255" value="" x="Foto"/>
                    </div>
                </li> 
